...
<tr align="center">
	<td colspan="6"> <h2>Pending Bids</h2></td>
</tr>
...
//Getting bid details for pending bids
$get_bids="select * from bids where status='0'";
$run_bids=mysqli_query($conn,$get_bids);
//Checking to see if there are any bids
$count_bids=mysqli_num_rows($run_bids);
if($count_bids==0)
{
    echo"<h2>There Are No Currently Pending Bids</h2>";
    exit();
}
else
{
